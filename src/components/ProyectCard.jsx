  ...
  return (
    <div class="proyect">
      ...
      <div class="bottom-section">
        <span class="title">{proyect.name}</span>
        <div class="row row1">
          <div class="item">
            <span class="big-text">{proyect.date}</span>
            <span class="regular-text">UI elements</span>
          </div>
          <div class="item">
            <span class="big-text">{proyect.process}</span>
            <span class="regular-text">{proyect.license}</span>
          </div>
          <div class="item">
            <span class="big-text">{proyect.visit}</span>
